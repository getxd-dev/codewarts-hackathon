    ...
    <section className="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <form onSubmit={handleSubmit} className="mt-8 rounded-lg border border-bayanihan-border bg-white p-5 shadow-soft sm:p-7">
        ...
        <div className="mt-7 flex flex-col gap-3 sm:flex-row sm:justify-between">
          ...
          <button
            type="submit"
            className="inline-flex min-h-11 items-center justify-center gap-2 rounded-md bg-bayanihan-green px-5 font-bold text-white transition hover:bg-bayanihan-red"
          >
            Continue to Upload
